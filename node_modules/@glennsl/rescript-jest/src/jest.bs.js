...
function testPromise(name, timeout, callback) {
  test(name, (function () {
          return Js_promise2.then(callback(), (function (a) {
...
function testAllPromise(name, inputs, timeout, callback) {
  List.iter((function (input) {
          var name$1 = name + " - " + String(input);
          test(name$1, (function () {
                  return Js_promise2.then(callback(input), (function (a) {
                                return Promise.resolve(affirm(a));
                              }));
                }), Js_undefined.fromOption(timeout));
        }), inputs);
...
function testPromise$2(name, param, callback) {
  it.skip(name, Curry.__1(callback));
}
...
function testAllPromise$2(name, inputs, param, callback) {
  List.iter((function (input) {
          var name$1 = name + " - " + String(input);
          testPromise$2(name$1, undefined, (function () {
                  return callback(input);
                }));
        }), inputs);
}
...
function $great(a, b) {
  return toBeGreaterThan(a, b);
}

function $great$eq(a, b) {
  return toBeGreaterThanOrEqual(a, b);
}

function $less(a, b) {
  return toBeLessThan(a, b);
}

function $less$eq(a, b) {
  return toBeLessThanOrEqual(a, b);
}
...
function Runner(funarg) {
  ...
  var testPromise = function (name, timeout, callback) {
    test(name, (function () {
            return Js_promise2.then(callback(), (function (a) {
                          return Promise.resolve(funarg.affirm(a));
                        }));
          }), Js_undefined.fromOption(timeout));
  };
